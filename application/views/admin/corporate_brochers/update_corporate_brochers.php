      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Update Corporate_brochers </h3>
          </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td> <input type="file" name="file" class="form-control" placeholder="" />
                        <?php if($corporate_brochers_data->image!=""){ echo base_url().$corporate_brochers_data->image; ?>  <?php }else{ ?> Sorry No File Found <?php } ?> </td>
                    </tr>
                    <tr>
