                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="name" class="form-control" placeholder="" required value="<?= $banner->name; ?>" />
                      </td>
                    </tr>
                    <tr>
                      <td> <strong>Redirection Link</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                        <input type="text" name="redirection_link" class="form-control" placeholder="" required value="<?= $banner->link; ?>" />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <?php if($banner->image!=""){  ?>
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url() ?><?php echo $banner->image; ?>">
                        <?php }else {  ?>
