 	 ...
 	 <th>Image</th>
        ...
        <tbody>
        <?php $i=1; foreach($corporateorder_data->result() as $data) { ?>
        <tr>
        <td><?php echo $i ?> </td>
 	 ...
 	 <td><?php echo $data->name ?></td>
        ...
        <li><a href="<?php echo base_url() ?>dcadmin/corporateorder/updatecorporateorderStatus/<?php echo
        base64_encode($data->id) ?>/inactive">Inactive</a></li>
        <?php } else { ?>
        <li><a href="<?php echo base_url() ?>dcadmin/corporateorder/updatecorporateorderStatus/<?php echo
        base64_encode($data->id) ?>/active">Active</a></li>
        <?php } ?>
        <li><a href="<?php echo base_url() ?>dcadmin/corporateorder/update_corporateorder/<?php echo
        ...
        <a href="<?php echo base_url() ?>dcadmin/corporateorder/delete_corporateorder/<?php echo
