      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="swiper-wrapper fist_slider ">
            <div class="swiper-slide"><a href="all product.html">
                <img
                  src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/paolo1-desk.jpg"
                  alt="">
              </a></div>
            <div class="swiper-slide"><a href="all product.html">
                <img
                  src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/paolo2-desk.jpg"
                  alt="">
              </a></div>
            <div class="swiper-slide">
              <a href="all product.html">
                <img
                  src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/gifting-desk.jpg"
                  alt="">
              </a>
            </div>
            <div class="swiper-slide"><a href="all product.html">
            ...
            <div class="swiper-slide"><a href="all product.html">
                <img
                  src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/mall-desktop.jpg"
                  alt="">
              </a></div>
            <div class="swiper-slide"><a href="all product.html">
                <img
  ...
  <section class="our_cat mt-1 overflow-hidden">
    <div class="container-fluid">
      <h2 class="text-center py-5" style="font-family: 'Playfair Display', serif;">Our Categories</h2>
      <div class="row">
        <div class="col-lg-2 col-sm-4 mg">

          <a href="all product.html" style="text-decoration: none; color: black;">
            <img
              src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/sofas.png"
              alt="">
            <p>sofa</p>
          </a>
        ...
        <div class="col-lg-2 col-sm-4 mg">
          ...
          <a href="all product.html" style="text-decoration: none; color: black;">
            <img
              src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/floor_lamps.png"
              alt="">
            <p>floor lamps</p>
          </a>
        </div>
        ...
        <div class="col-lg-2 col-sm-4 mg">
          ...
          <a href="all product.html" style="text-decoration: none; color: black;">
            <img
              src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/wall_mirros.png"
              alt="">
            <p>Wall Mirros</p>
          </a>
        </div>
        ...
        <div class="col-lg-2 col-sm-4 mg">
          ...
          <a href="all product.html" style="text-decoration: none; color: black;">
            <img
              src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/study_tables.png"
              alt="">
            <p>Study Tables</p>
          </a>
    ...
    <div class="container-fluid">
      ...
      <div class="row" id="para">
        <div class="col-md-12">
          ...
          <!-- 3... -->
          <div id="AddressTable" class="TableBody" style="display:none">
            <div class="swiper-wrapper autoplay" id="changenex1">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
          <div>
            <a href="all product.html">
              <img style="width: 1483px;"
                src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/get-look-paolo-desk.jpg"
                alt="">
            </a>
          </div>
  ...
  <section class="new_lunc overflow-hidden">
    <div class="container-fluid">
      <h2 class="text-center py-5"
        style="font-family: 'Playfair Display', serif; font-size: 45px; margin-bottom: -40px;">Best Sellers</h2>
      <div class="row">
        <div class="col-md-12">
          <!-- Swiper -->
        ...
        <div class="col-md-12">
          ...
          <div class="swiper-wrapper decor">
            <div class="swiper-slide">
              <a href="all product.html">
                <img
                  src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/paolo1-latest.jpg"
                  alt="">
              </a>
              <!-- <div class="my-3">
                <h6>Emperor Sofa Collection</h6> <span style="font-weight: bold; font-size: 12px;"> ₹38,400</span>
            ...
            <div class="swiper-slide">
              <a href="all product.html">
                <img
                  src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/paolo2-latest.jpg"
                  alt="">
              </a>
              <!-- <div class="my-3">
                <h6>Emperor Sofa Collection</h6> <span style="font-weight: bold; font-size: 12px;"> ₹38,400</span>
  ...
  <section class="promis overflow-hidden">
    <h2 class="text-center py-5"
      style="color: gray; font-size: 39px; font-family: 'Montserrat', sans-serif; font-weight: bolder;">The Orange Tree
      Promise</h2>
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-3 col-12" style="font-family: 'Playfair Display', serif;">
          <ul>
            <li>
              <div class="img_1"><img src="<?=base_url()?>assets/frontend/assets/img/icn01.jpg" alt="" style="width: 80%;"></div>
              <h2
                style="text-align: center; font-family: 'Playfair Display', serif; letter-spacing: 2px; font-size: 22px; font-style: italic;">
                Crafted in <br>India</h2>
              <br>
              <p
                style="font-family: 'M PLUS Code Latin', sans-serif; text-align:center; color: #3e3938; line-height: 31px;;">
        ...
        <div class="col-md-3 col-12">
          <ul>
            <li>
              <div class="img_1"><img
                  src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/icn02.jpg"
        ...
        <div class="col-md-3 col-12">
          <ul>
            ...
            <li>
              <div class="img_1"><img
                  src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/icn03.jpg"
                  alt="" style="width: 80%;"></div>
              <h2
                style="text-align: center; font-family: 'Playfair Display', serif; letter-spacing: 2px; font-size: 22px; font-style: italic;">
        ...
        <div class="col-md-3 col-12">
          <ul>
            ...
            <li>
              <div class="img_1"><img
                  src="https://www.orangetree.in/pub/static/version1632556275/frontend/Digital/desktop/en_US/images/furniture/icn04.jpg"
                  alt="" style="width: 80%;"></div>
              <h2
                style="text-align: center; font-family: 'Playfair Display', serif; letter-spacing: 2px; font-size: 22px; font-style: italic;">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="say">
            <div class=""><img
                src="https://www.orangetree.in/pub/media/yereone/testimonials/images/catch/390//k/h/khaab_wall_mirror.png"
                alt="">
            ...
            <div class=""><img
                src="https://www.orangetree.in/pub/media/yereone/testimonials/images/catch/390//7/c/7c2c3d52-0709-4097-a291-395dac38be2e.jpeg"
                alt="">
              <div class="yereone-testimonial-content"><span>The classy look of this mirror perfectly fits my fairy tale
                  imaginations. Loved the product! <span class="yereone-testimonial-author">Decode Architecture</span>
                </span></div>
            ...
            <div class=""><img
                src="https://www.orangetree.in/pub/media/yereone/testimonials/images/catch/390//n/i/nihita_bajaj_mumbai_wedding_planner.jpg"
                alt="">
              <div class="yereone-testimonial-content"><span>The classy look of this mirror perfectly fits my fairy tale
                  imaginations. Loved the product! <span class="yereone-testimonial-author">Decode Architecture</span>
                </span></div>
            ...
            <div class=""><img
                src="https://www.orangetree.in/pub/media/yereone/testimonials/images/catch/390//n/a/namrata_soni.jpg"
                alt="">
              <div class="yereone-testimonial-content"><span>The classy look of this mirror perfectly fits my fairy tale
                  imaginations. Loved the product! <span class="yereone-testimonial-author">Decode Architecture</span>
                </span></div>
            ...
            <div class=""><img
                src="https://www.orangetree.in/pub/media/yereone/testimonials/images/catch/390//t/e/test-2-02.jpg"
                alt="">
              <div class="yereone-testimonial-content"><span>The classy look of this mirror perfectly fits my fairy tale
                  imaginations. Loved the product! <span class="yereone-testimonial-author">Decode Architecture</span>
                </span></div>
            ...
            <div class=""><img
                src="https://www.orangetree.in/pub/media/yereone/testimonials/images/catch/390//p/r/priyanshu_maheshwari-01-01.jpg"
                alt="">
              <div class="yereone-testimonial-content"><span>The classy look of this mirror perfectly fits my fairy tale
                  imaginations. Loved the product! <span class="yereone-testimonial-author">Decode Architecture</span>
                </span></div>
            ...
            <div class=""><img
                src="https://www.orangetree.in/pub/media/yereone/testimonials/images/catch/390//b/e/bean_brewer_cafe4.jpg"
                alt="">
              <div class="yereone-testimonial-content"><span>The classy look of this mirror perfectly fits my fairy tale
                  imaginations. Loved the product! <span class="yereone-testimonial-author">Decode Architecture</span>
                </span></div>
            ...
            <div class=""><img
                src="https://www.orangetree.in/pub/media/yereone/testimonials/images/catch/390//t/i/tina_kakkad.jpg"
                alt="">
              <div class="yereone-testimonial-content"><span>The classy look of this mirror perfectly fits my fairy tale
                  imaginations. Loved the product! <span class="yereone-testimonial-author">Decode Architecture</span>
                </span></div>
            ...
            <div class=""><img
                src="https://www.orangetree.in/pub/media/yereone/testimonials/images/catch/390//t/e/test-2-03.jpg"
                alt="">
              <div class="yereone-testimonial-content"><span>The classy look of this mirror perfectly fits my fairy tale
                  imaginations. Loved the product! <span class="yereone-testimonial-author">Decode Architecture</span>
                </span></div>
  ...
  <section>
    ...
    <div class="items">
      ...
      <div><img src="https://d5t4h5a9.rocketcdn.me/wp-content/uploads/2020/11/Professional-Headshot-Poses-Blog-Post.jpg"
          style="width: 100%; height:30%; padding: 10px;">
        <div class="dfg col-md-2"><i class="fa fa-quote-left"></i></div>
        <div class="dfg" style="width: auto;">
          <p style="text-align: center; font-size:14px;">Very happy with this unique floor lamp,<br>this has become my
