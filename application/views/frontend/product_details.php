          ...
          <div class="accordion" id="accordionExample" onclick="transfunction()">
            <div class="card">
              <div class="card-header" id="headingOne">
                <h2 class="mb-0">
                  <button class="btn btnm btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    details
                  </button>
                </h2>
              </div>
