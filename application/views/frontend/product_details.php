              ...
              <div class="rr ">
                ...
                <div class="xc">
                  ...
                  <div class="container">
                    ...
                    <!-- <p><span><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal"
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <br>
                                <br>
                                <input type="Pin Code" placeholder="Pin Code" style="border: 1px solid black; border-top: 0; border-right: 0; border-left: 0; width: 100%; outline: none;">
                              </div>
                              <div class="modal-footer" style="justify-content: center;">
                                <button type="button" class="btn btn-default" data-dismiss="modal" style="background-color: #de542d; border-radius: 18px; padding-left: 75px; padding-right: 75px; color: white;">CHECK</button>
                              </div>
                            </div>
