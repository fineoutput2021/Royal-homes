...
.xmp{
      ...
      font-size: 13px;
      letter-spacing: 2px;line-height: 1.2rem;
       padding: 11px 58px;
}
.xmp:hover{
...
input[type=number]{background:#fff;background-clip:padding-box;border:1px solid #c2c2c2;border-radius:1px;font-family:'Open Sans','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;height:32px;line-height:1.42857143;padding:0 9px;vertical-align:baseline;width:100%;box-sizing:border-box;}
input[type=number]:disabled{opacity:.5;}
input[type=number]::-moz-placeholder{color:#c2c2c2;}
input[type=number]::-webkit-input-placeholder{color:#c2c2c2;}
input[type=number]:-ms-input-placeholder{color:#c2c2c2;}
...
input[type=number]{background:#fff;background-clip:padding-box;border:1px solid #c2c2c2;border-radius:1px;font-size:14px;height:32px;line-height:1.42857143;padding:0 9px;vertical-align:baseline;width:100%;box-sizing:border-box;}
div#custom-qty .input-group input#qty{pointer-events:none;}
div#error-response{text-align:center;left:0;position:absolute;z-index:3;font-size:14px;background:#f1f1f1;width:280px;padding:20px;box-shadow:0px 0px 5px 1px #c9c9c9;border-radius:20px;top:42px;}
div#custom-qty{position:relative;}
div#error-response a{color:#e66b47;}
input:not([disabled]):focus{box-shadow:none!important;}
input:not([disabled]):focus{box-shadow:none;}
div#custom-qty{display:block;margin-bottom:0;}
div#custom-qty .input-group{display:flex;align-items:center;}
div#custom-qty .input-group span.input-group__addon{display:inline-block;width:40px;text-align:center;padding:7px 0;border:1px solid #ccc;cursor:pointer;height:32px;font-size:15px;line-height:1;}
div#custom-qty .input-group input#qty{display:inline-block;width:50px;text-align:center;}
div#custom-qty .input-group span.input-group__addon:first-child{border-right:0;border-top-left-radius:20px;border-bottom-left-radius:20px;}
div#custom-qty .input-group span.input-group__addon:last-child{border-left:0;border-top-right-radius:20px;border-bottom-right-radius:20px;}
}
...
/*! CSS Used fontfaces */
@font-face{font-family:'Open Sans';src:url('https://www.orangetree.in/pub/static/version1642005426/frontend/Digital/desktop/en_US/fonts/opensans/light/opensans-300.woff2') format('woff2'),url('https://www.orangetree.in/pub/static/version1642005426/frontend/Digital/desktop/en_US/fonts/opensans/light/opensans-300.woff') format('woff');font-weight:300;font-style:normal;font-display:swap;}
@font-face{font-family:'Open Sans';src:url('https://www.orangetree.in/pub/static/version1642005426/frontend/Digital/desktop/en_US/fonts/opensans/regular/opensans-400.woff2') format('woff2'),url('https://www.orangetree.in/pub/static/version1642005426/frontend/Digital/desktop/en_US/fonts/opensans/regular/opensans-400.woff') format('woff');font-weight:400;font-style:normal;font-display:swap;}
@font-face{font-family:'Open Sans';src:url('https://www.orangetree.in/pub/static/version1642005426/frontend/Digital/desktop/en_US/fonts/opensans/semibold/opensans-600.woff2') format('woff2'),url('https://www.orangetree.in/pub/static/version1642005426/frontend/Digital/desktop/en_US/fonts/opensans/semibold/opensans-600.woff') format('woff');font-weight:600;font-style:normal;font-display:swap;}
@font-face{font-family:'Open Sans';src:url('https://www.orangetree.in/pub/static/version1642005426/frontend/Digital/desktop/en_US/fonts/opensans/bold/opensans-700.woff2') format('woff2'),url('https://www.orangetree.in/pub/static/version1642005426/frontend/Digital/desktop/en_US/fonts/opensans/bold/opensans-700.woff') format('woff');font-weight:700;font-style:normal;font-display:swap;}
</style>
<section>
  <!-- slider start -->
<div class="row ffth">
          ...
          <div class="">
            <ul>
              <li style="display:flex">
                <span>Quantity:</span>
                <div id="custom-qty" class="control" data-bind="scope: 'qty-counter'"><!-- ko template: getTemplate() --><div class="input-group">
    <span class="input-group__addon">
        <div class="input-group__button input-group__button--decrease" data-bind="click: decreaseQty">
            <span class="input-group__icon input-group__icon--decrease">-</span>
        </div>
    </span>
    <input type="number" style="color:black" name="qty" id="qty" min="1" value="1" maxlength="12" class="input-group__input" title="Qty">
    <span class="input-group__addon">
...
<div id="error-response" style="display: none;">The Requested Quantity is not available, Please enquire on the given link for a <a href="/bulk-orders" target="_blank">Bulk order</a></div>
<!-- /ko --></div>
                <!-- <div class="ml-5">
                <div style="border-right: 0;
  border-top-left-radius: 20px;
  border-bottom-left-radius: 20px;" class="value-button" id="decrease" onclick="decreaseValue()" value="Decrease Value">-</div>
                <input type="text" id="number" minlenth="1" value="1" style="box-sizing: border-box;"/>
                <div style="border-left: 0;
  border-top-right-radius: 20px;
  border-bottom-right-radius: 20px;" class="value-button" id="increase" onclick="increaseValue()" value="Increase Value">+</div>
              </div> -->
              </li>
            </ul>
          </div>
          <!-- <div class="row" style="align-item:center; cursor: pointer;">
          <p>
            <b style="font-size: 14px;font-weight:100; margin-left: 17px">Quantity :</b>
                        <div class="gfgft" >
            <div class="form11">

                        <div class="value-button" id="decrease" onclick="decreaseValue()" value="Decrease Value">-</div>
                        <input type="number" id="number" minlenth="1" value="1" />
          ...
          <div  class="hov_col1" style="align-items:center;" >
            ...
            <div class="col-md-6 rrcs" style=" padding:0px!important;">
              <a href="" class="xmp" onclick="addToCartOffline(this)" id="add_cart" product_id="<?=base64_encode($product_data->id)?>" quantity=1>Add To Cart</a>
            </div>
            <?} else {?>
            <div class="col-md-6 rrcs" style="width:auto; padding:0px!important;">
              <a href="" class="xmp" onclick="addToCartOnline(this)" id="add_cart" product_id="<?=base64_encode($product_data->id)?>" quantity=1>Add To Cart</a>
            </div>
