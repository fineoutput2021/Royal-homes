...
<section>
       ...
       <div class="col-md-12 designbyheart">
           ...
           <p class=" text-center">Design is sensitivity!! It's being sensitive to form, to function, to materials, to techniques, to nature, to craft. Absorb and let your soul express itself , in a different context each time. We culminate various materials, textures, techniques under one central theme and innovate keeping the style minimalistic and contemporary.</p>
           </div>
       </div>
       ...
       <div class="col-md-12">
           <div class= "position-relative "><img class="img-fluid" src="https://www.orangetree.in/pub/media/wysiwyg/pholisophy.jpg" alt="">
               ...
               <p class=" text-center">
                   We believe in cultivating relationships between culture, craftsmanship and industry, reconcile memory and research, rigour and emotion, uniqueness and experimentation, and interpret global trends with constant effort dedicated to aesthetics- contemporary in form but handcrafted in spirit
               </p>
               <p class=" text-center">We also believe in sustainable design meaning creating products from responsible sustainable materials that can last a lifetime. Our products are generally made of wood(sourced from responsibly managed forests) , metal, stone, natural fibers which highlight physical and aesthetic durability.</p>
               </div>
               </div>
       </div>
       ...
       <div class="movingahead">
           ...
           <p >We works towards maintaining balance between ecosystem and economy. 50% of total power consumption is Solar based and water harvesting is encouraged. We maintain highest standards in quality and have SA certification, FSC, UL, CE and 'Vriksh'.</p>
           </div>
           <div class="col-xl-4 col-lg-4 col-md-2 col-sm-4 text-center">
           <h2>Materials</h2>
           ...
           <p >We have come a long way from a handful of employees, single factory in Jodhpur to 9,35,000 sqft built up area that houses wood workshops, dedicated testing labs, powder coating area, metal workshops and an expanded upholstery unit all under one roof. We work with 600+ expert draughtsmen, designers, artisans and specialised workers whose talent and skills we rely on.</p>
           </div>
           <div class="col-xl-4 col-lg-4 col-md-2 col-sm-4 text-center">
           <h2>Design Awards</h2>
