<?php
    ...
    if (! defined('BASEPATH')) {
       ...
       class Custom_brochers extends CI_finecontrol
       {
           ...
           public function view_custom_brochers()
           {
               if (!empty($this->session->userdata('admin_data'))) {
                   ...
                   $data['custom_brochers_data']= $this->db->get();

                   $this->load->view('admin/common/header_view', $data);
                   $this->load->view('admin/custom_brochers/view_custom_brochers');
           ...
           public function add_custom_brochers()
           {
               if (!empty($this->session->userdata('admin_data'))) {
                   $this->load->view('admin/common/header_view');
                   $this->load->view('admin/custom_brochers/add_custom_brochers');
                   $this->load->view('admin/common/footer_view');
               } else {
                   redirect("login/admin_login", "refresh");
               }
           ...
           public function update_custom_brochers($idd)
           {
               if (!empty($this->session->userdata('admin_data'))) {
                   $data['user_name']=$this->load->get_var('user_name');
           ...
           public function add_custom_brochers_data($t, $iw="")
           {
               if (!empty($this->session->userdata('admin_data'))) {
  ...
  'image'=>$nnnn2,
           ...
           public function updatecustom_brochersStatus($idd, $t)
           {
               if (!empty($this->session->userdata('admin_data'))) {
                   $data['user_name']=$this->load->get_var('user_name');
           ...
           public function delete_custom_brochers($idd)
           {
               if (!empty($this->session->userdata('admin_data'))) {
                   $data['user_name']=$this->load->get_var('user_name');
