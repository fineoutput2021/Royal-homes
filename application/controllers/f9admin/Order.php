            ...
            if(!empty($this->session->userdata('admin_data'))){
             ...
             redirect("login/admin_login","refresh");
              ...
              public function add_order(){
               ...
               public function update_order($idd){
                   ...
                   if(!empty($this->session->userdata('admin_data'))){
                     ...
                     $this->load->view('admin/common/header_view',$data);
                     $this->load->view('admin/order/update_order');
                     $this->load->view('admin/common/footer_view');
             ...
             public function add_order_data($t,$iw="")
...
$img1='image';
         ...
         $image_upload_folder = FCPATH . "assets/uploads/order/";
                     if (!file_exists($image_upload_folder))
                     {
                         mkdir($image_upload_folder, DIR_WRITE_MODE, true);
                     }
                     $new_file_name="order".date("Ymdhms");
           ...
           //$this->session->set_flashdata('emessage',$upload_error);
             //redirect($_SERVER['HTTP_REFERER']);
                     ...
                     else
                     {
                         ...
                         $videoNAmePath = "assets/uploads/order/".$new_file_name.$file_info['file_ext'];
...
$img2='image1';
         ...
         $image_upload_folder = FCPATH . "assets/uploads/order/";
                     ...
                     $new_file_name="order1".date("Ymdhms");
                     $this->upload_config = array(
                             'upload_path'   => $image_upload_folder,
                             'file_name' => $new_file_name,
                             'allowed_types' =>'xlsx|csv|xls|pdf|doc|docx|txt|jpg|jpeg|png',
...
if(!empty($img)) { if(empty($nnnn2)){ $nnnn2 = $img; } }else{ if(empty($nnnn2)){ $nnnn2= ""; } } }
  ...
  'image1'=>$nnnn2,
             ...
             $this->db->where('id', $idw);
             $last_id=$this->db->update('tbl_order', $data_insert);
           }
                       if($last_id!=0){
                               $this->session->set_flashdata('smessage','Data inserted successfully');
                               redirect("dcadmin/order/view_order","refresh");
                              }
                               else
                                   {
       ...
       redirect("login/admin_login","refresh");
        ...
        $this->session->set_flashdata('emessage','Sorry error occured');
          redirect($_SERVER['HTTP_REFERER']);
               ...
               public function delete_order($idd){
 ...
 $zapak=$this->db->delete('tbl_order', array('id' => $id));
 if($zapak!=0){
        $path = FCPATH .$img;
          unlink($path);
        redirect("dcadmin/order/view_order","refresh");
